        ...
        <>
            ...
            <div>
                ...
                <div className='profile'>
                    ...
                    <div className='bio'>
                        <p>You know my name but not my story !</p>
                    </div>
                    ...
                    <div className='info'>
                        ...
                        <div className='birthdate icon'>
                            ...
                            <p>Naissance le 21 janvier 2021</p>
                        </div>
                        <div className='inscription-date icon'>
                            ...
                            <p>A rejoint Twitter en janvier 2022 </p>
                        </div>
                    </div>

                    <div className='follow'>
                        <p><span className='number'>0</span>abonnements</p>
                        <p><span className='number'>0</span>abonnés</p>
                    </div>
                </div>
