  ...
  return (
    <div>
      <div className='rounded-pill research'>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="darkgray" className="bi bi-search" viewBox="0 0 16 16">
      ...
      <div className='suggestion'>
        <div className='d-flex justify-content-between align-items-center'>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-gear mb-4" viewBox="0 0 16 16">
